...
int main(int argc, char *argv[])
{
	...
	if (nwg != 1) ocl_check(CL_INVALID_VALUE, "nwg");
	...
	const double runtime_reduction_ms = total_runtime_ms(scan_evt[0], scan_evt[0]);
